...
import FaceRecognition from './compontents/FaceRecognition/FaceRecognition';
...
class App extends Component {
  ...
  onPhotoSubmit = () => {
    ...
    fetch('https://cryptic-woodland-93397.herokuapp.com/imageurl', {
      method: 'post',
      ...
      .then(response => {
        if(response) {
          fetch('https://cryptic-woodland-93397.herokuapp.com/image', {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
